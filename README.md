...
一款面向应用与软件场景的 **图标浏览、定制与生成** 开源工具。内置 **500+** 分类图标（Lucide 矢量 + 渐变圆角背景），支持全库搜索、手绘草图转图标、多格式导出，并接入 **OpenAI 兼容的大模型 API**——用自然语言描述即可智能生成图标。

> 纯前端运行，无需后端。AI 密钥仅存于浏览器本地，适合个人开发者、独立应用与小型团队快速产出统一风格的软件图标。

**[English](#english)（简要说明见文末）**
...
> 截图位于 [`Image/`](Image/) 目录。若 GitHub 上未显示，请确认已提交该目录下的图片文件。

<table>
  <tr>
    <td align="center" width="50%">
      <strong>主题分类</strong><br/>
      <sub>12 大类可折叠侧栏</sub><br/><br/>
      <img src="./Image/0-categories.png" alt="主题分类侧栏" width="100%" />
    </td>
    <td align="center" width="50%">
      <strong>社交与媒体</strong><br/>
      <sub>图标网格浏览与选中</sub><br/><br/>
      <img src="./Image/1-social-media.png" alt="社交与媒体图标集" width="100%" />
    </td>
  </tr>
  <tr>
    <td align="center" width="50%">
      <strong>图标定制</strong><br/>
      <sub>渐变背景与徽标文字</sub><br/><br/>
      <img src="./Image/3-customize.png" alt="图标外观定制" width="100%" />
    </td>
    <td align="center" width="50%">
      <strong>多格式导出</strong><br/>
      <sub>PNG / JPEG / SVG / ICO</sub><br/><br/>
      <img src="./Image/2-export.png" alt="导出设置" width="100%" />
    </td>
  </tr>
  <tr>
    <td align="center" colspan="2">
      <strong>AI 生成模块</strong><br/>
      <sub>配置 API Key、模型与生成模式</sub><br/><br/>
      <img src="./Image/4-ai-module.png" alt="AI 生成配置" width="80%" />
    </td>
  </tr>
</table>

<details>
<summary>单独查看各截图（Markdown 链接）</summary>

| 预览 | 链接 |
|------|------|
| 主题分类 | [0-categories.png](./Image/0-categories.png) |
| 社交与媒体 | [1-social-media.png](./Image/1-social-media.png) |
| 图标定制 | [3-customize.png](./Image/3-customize.png) |
| 多格式导出 | [2-export.png](./Image/2-export.png) |
| AI 模块 | [4-ai-module.png](./Image/4-ai-module.png) |
...
```bash
# 克隆仓库
git clone https://github.com/YOUR_USERNAME/design-software-icons.git
...
构建产物输出至 `dist/`，可部署到 GitHub Pages、Vercel、Netlify 或任意静态服务器。
...
Image/                                # README 截图（0-categories.png 等）
scripts/
...
| UI | Radix UI、shadcn/ui 组件 |

---

## 参与贡献

欢迎 Issue 与 Pull Request！详细指南见 [CONTRIBUTING.md](CONTRIBUTING.md)。
...
提交 PR 前请确保 `npm run build` 通过。GitHub Actions 会在 PR 时自动执行构建检查。
...
**Q：可以商用吗？**  
本项目代码以 MIT 协议开源；图标基于 Lucide（ISC），UI 组件见 [ATTRIBUTIONS.md](ATTRIBUTIONS.md)。使用第三方 AI API 须遵守对应服务商条款。
...
第三方依赖与素材说明见 [ATTRIBUTIONS.md](ATTRIBUTIONS.md)。

使用 OpenAI、DeepSeek 等 API 时，须遵守各服务商的使用条款与计费规则。

---

## English

**Design Software Icons** is a browser-based icon browser, customizer, and generator for apps and software. It ships with 500+ categorized Lucide icons, full-library search, sketch-to-SVG, multi-format export (PNG/JPEG/SVG/ICO), and optional **OpenAI-compatible AI generation** using your own API key (stored locally only).

```bash
npm install && npm run dev
```

See sections above for AI setup, search, and project structure. Contributions welcome!
